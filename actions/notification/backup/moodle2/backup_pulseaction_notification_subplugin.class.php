...
class backup_pulseaction_notification_subplugin extends backup_subplugin {
    ...
    protected function define_pulse_autoinstances_subplugin_structure() {
        ...
        $actionfields = new \backup_nested_element('pulseaction_notification', ['id'], [
            ...
            "delayduration", "notifylimit", "recipients", "cc", "bcc", "subject", "headercontent", "headercontentformat",
            "staticcontent", "staticcontentformat", "dynamiccontent", "contentlength", "contenttype", "footercontent",
            "footercontentformat", "timemodified",
        ]);
        ...
        $actioninsfields = new \backup_nested_element('pulseaction_notification_ins', ['id'], [
            ...
            "delayduration", "suppress", "suppressoperator", "notifylimit", "recipients", "cc", "bcc", "subject", "headercontent",
            "staticcontent", "dynamiccontent", "contentlength", "contenttype", "chapterid", "footercontent", "timemodified",
        ]);
